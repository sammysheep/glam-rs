...
fn write_vec4_impl_std_simd(out: &mut impl Write) -> Result<()> {
    const SIZE: usize = 4;
...
"#,
    ...
    #[inline]
    fn {}{}{}{}(self) -> Vec4 {{
        Vec4(simd_swizzle!(self.0, [{}, {}, {}, {}]))
    }}"#,
                E[e0], E[e1], E[e2], E[e3], L[e0], L[e1], L[e2], L[e3],
            )
        },
        |out, e0, e1, e2| {
            write!(
    ...
    #[inline]
    fn {}{}{}(self) -> Vec3 {{
        Vec3(XYZ::from(simd_swizzle!(self.0, [{}, {}, {}, {}])))
    }}"#,
                E[e0], E[e1], E[e2], L[e0], L[e1], L[e2], L[0],
            )
        },
        |out, e0, e1| {
            write!(
    ...
    #[inline]
    fn {}{}(self) -> Vec2 {{
        Vec2(XY::from(simd_swizzle!(self.0, [{}, {}, {}, {}])))
    }}"#,
                E[e0], E[e1], L[e0], L[e1], L[0], L[0],
            )
        },
    )?;
...
fn write_vec3a_impl_std_simd(out: &mut impl Write) -> Result<()> {
    const SIZE: usize = 3;
...
fn write_swizzle_impls_f32() -> Result<()> {
    ...
    let mut out = File::create("../src/swizzles/vec4_impl_simd.rs")?;
    write_vec4_impl_std_simd(&mut out)?;

    let mut out = File::create("../src/swizzles/vec3a_impl_simd.rs")?;
    write_vec3a_impl_std_simd(&mut out)?;
