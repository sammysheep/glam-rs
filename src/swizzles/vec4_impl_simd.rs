...
impl Vec4Swizzles for Vec4 {
    ...
    #[inline]
    fn xxx(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [0, 0, 0, 0])))
    }
    #[inline]
    fn xxy(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [0, 0, 1, 0])))
    }
    #[inline]
    fn xxz(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [0, 0, 2, 0])))
    }
    #[inline]
    fn xxw(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [0, 0, 3, 0])))
    }
    #[inline]
    fn xyx(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [0, 1, 0, 0])))
    }
    #[inline]
    fn xyy(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [0, 1, 1, 0])))
    }
    #[inline]
    fn xyz(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [0, 1, 2, 0])))
    }
    #[inline]
    fn xyw(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [0, 1, 3, 0])))
    }
    #[inline]
    fn xzx(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [0, 2, 0, 0])))
    }
    #[inline]
    fn xzy(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [0, 2, 1, 0])))
    }
    #[inline]
    fn xzz(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [0, 2, 2, 0])))
    }
    #[inline]
    fn xzw(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [0, 2, 3, 0])))
    }
    #[inline]
    fn xwx(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [0, 3, 0, 0])))
    }
    #[inline]
    fn xwy(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [0, 3, 1, 0])))
    }
    #[inline]
    fn xwz(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [0, 3, 2, 0])))
    }
    #[inline]
    fn xww(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [0, 3, 3, 0])))
    }
    #[inline]
    fn yxx(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [1, 0, 0, 0])))
    }
    #[inline]
    fn yxy(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [1, 0, 1, 0])))
    }
    #[inline]
    fn yxz(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [1, 0, 2, 0])))
    }
    #[inline]
    fn yxw(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [1, 0, 3, 0])))
    }
    #[inline]
    fn yyx(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [1, 1, 0, 0])))
    }
    #[inline]
    fn yyy(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [1, 1, 1, 0])))
    }
    #[inline]
    fn yyz(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [1, 1, 2, 0])))
    }
    #[inline]
    fn yyw(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [1, 1, 3, 0])))
    }
    #[inline]
    fn yzx(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [1, 2, 0, 0])))
    }
    #[inline]
    fn yzy(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [1, 2, 1, 0])))
    }
    #[inline]
    fn yzz(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [1, 2, 2, 0])))
    }
    #[inline]
    fn yzw(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [1, 2, 3, 0])))
    }
    #[inline]
    fn ywx(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [1, 3, 0, 0])))
    }
    #[inline]
    fn ywy(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [1, 3, 1, 0])))
    }
    #[inline]
    fn ywz(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [1, 3, 2, 0])))
    }
    #[inline]
    fn yww(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [1, 3, 3, 0])))
    }
    #[inline]
    fn zxx(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [2, 0, 0, 0])))
    }
    #[inline]
    fn zxy(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [2, 0, 1, 0])))
    }
    #[inline]
    fn zxz(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [2, 0, 2, 0])))
    }
    #[inline]
    fn zxw(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [2, 0, 3, 0])))
    }
    #[inline]
    fn zyx(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [2, 1, 0, 0])))
    }
    #[inline]
    fn zyy(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [2, 1, 1, 0])))
    }
    #[inline]
    fn zyz(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [2, 1, 2, 0])))
    }
    #[inline]
    fn zyw(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [2, 1, 3, 0])))
    }
    #[inline]
    fn zzx(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [2, 2, 0, 0])))
    }
    #[inline]
    fn zzy(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [2, 2, 1, 0])))
    }
    #[inline]
    fn zzz(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [2, 2, 2, 0])))
    }
    #[inline]
    fn zzw(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [2, 2, 3, 0])))
    }
    #[inline]
    fn zwx(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [2, 3, 0, 0])))
    }
    #[inline]
    fn zwy(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [2, 3, 1, 0])))
    }
    #[inline]
    fn zwz(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [2, 3, 2, 0])))
    }
    #[inline]
    fn zww(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [2, 3, 3, 0])))
    }
    #[inline]
    fn wxx(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [3, 0, 0, 0])))
    }
    #[inline]
    fn wxy(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [3, 0, 1, 0])))
    }
    #[inline]
    fn wxz(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [3, 0, 2, 0])))
    }
    #[inline]
    fn wxw(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [3, 0, 3, 0])))
    }
    #[inline]
    fn wyx(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [3, 1, 0, 0])))
    }
    #[inline]
    fn wyy(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [3, 1, 1, 0])))
    }
    #[inline]
    fn wyz(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [3, 1, 2, 0])))
    }
    #[inline]
    fn wyw(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [3, 1, 3, 0])))
    }
    #[inline]
    fn wzx(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [3, 2, 0, 0])))
    }
    #[inline]
    fn wzy(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [3, 2, 1, 0])))
    }
    #[inline]
    fn wzz(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [3, 2, 2, 0])))
    }
    #[inline]
    fn wzw(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [3, 2, 3, 0])))
    }
    #[inline]
    fn wwx(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [3, 3, 0, 0])))
    }
    #[inline]
    fn wwy(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [3, 3, 1, 0])))
    }
    #[inline]
    fn wwz(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [3, 3, 2, 0])))
    }
    #[inline]
    fn www(self) -> Vec3 {
        Vec3(XYZ::from(simd_swizzle!(self.0, [3, 3, 3, 0])))
    }
    #[inline]
    fn xx(self) -> Vec2 {
        Vec2(XY::from(simd_swizzle!(self.0, [0, 0, 0, 0])))
    }
    #[inline]
    fn xy(self) -> Vec2 {
        Vec2(XY::from(simd_swizzle!(self.0, [0, 1, 0, 0])))
    }
    #[inline]
    fn xz(self) -> Vec2 {
        Vec2(XY::from(simd_swizzle!(self.0, [0, 2, 0, 0])))
    }
    #[inline]
    fn xw(self) -> Vec2 {
        Vec2(XY::from(simd_swizzle!(self.0, [0, 3, 0, 0])))
    }
    #[inline]
    fn yx(self) -> Vec2 {
        Vec2(XY::from(simd_swizzle!(self.0, [1, 0, 0, 0])))
    }
    #[inline]
    fn yy(self) -> Vec2 {
        Vec2(XY::from(simd_swizzle!(self.0, [1, 1, 0, 0])))
    }
    #[inline]
    fn yz(self) -> Vec2 {
        Vec2(XY::from(simd_swizzle!(self.0, [1, 2, 0, 0])))
    }
    #[inline]
    fn yw(self) -> Vec2 {
        Vec2(XY::from(simd_swizzle!(self.0, [1, 3, 0, 0])))
    }
    #[inline]
    fn zx(self) -> Vec2 {
        Vec2(XY::from(simd_swizzle!(self.0, [2, 0, 0, 0])))
    }
    #[inline]
    fn zy(self) -> Vec2 {
        Vec2(XY::from(simd_swizzle!(self.0, [2, 1, 0, 0])))
    }
    #[inline]
    fn zz(self) -> Vec2 {
        Vec2(XY::from(simd_swizzle!(self.0, [2, 2, 0, 0])))
    }
    #[inline]
    fn zw(self) -> Vec2 {
        Vec2(XY::from(simd_swizzle!(self.0, [2, 3, 0, 0])))
    }
    #[inline]
    fn wx(self) -> Vec2 {
        Vec2(XY::from(simd_swizzle!(self.0, [3, 0, 0, 0])))
    }
    #[inline]
    fn wy(self) -> Vec2 {
        Vec2(XY::from(simd_swizzle!(self.0, [3, 1, 0, 0])))
    }
    #[inline]
    fn wz(self) -> Vec2 {
        Vec2(XY::from(simd_swizzle!(self.0, [3, 2, 0, 0])))
    }
    #[inline]
    fn ww(self) -> Vec2 {
        Vec2(XY::from(simd_swizzle!(self.0, [3, 3, 0, 0])))
    }
}
